export const projects = [
  {
    ...
    description:
      "Interactive pharmaceutical manufacturing case study featuring OEE, DMAIC, Fishbone, 5 Whys, FMEA, process capability, cGMP, CAPA, validation, and a future-state roadmap.",
    tech: [
      "Lean Six Sigma",
      "DMAIC",
      "OEE",
    ...
    live:
      "https://jd-dev-king.github.io/Manufacturing-Process-Optimization-Case-Study-/",
    github:
      "https://github.com/jd-dev-king/Manufacturing-Process-Optimization-Case-Study-",
    accent: "cyan",
    icon: "factory",
    liveLabel: "Launch Case Study"
  },
  {
    ...
    description:
      "Lean Six Sigma DMAIC case study transforming a 27-page process-improvement project into an interactive engineering experience.",
    tech: [
      "Lean Six Sigma",
      "5S",
      "DMAIC",
    ...
    live:
      "https://jd-dev-king.github.io/First-Run-Parts-Interactive-Case-Study/",
    github:
      "https://github.com/jd-dev-king/First-Run-Parts-Interactive-Case-Study",
    accent: "lime",
    icon: "quality",
    liveLabel: "Launch Case Study"
  },
